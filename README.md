# 💫 Sobre mi:
Tecnóloga en Análisis y Desarrollo de Software y Administradora de Negocios Internacionales con una perspectiva única para resolver problemas a través de la tecnología. Mi trayectoria previa como Tecnóloga y Especialista en Seguridad y Salud en el Trabajo me ha proporcionado un profundo conocimiento en el análisis de procesos, gestión de riesgos y manejo de datos, habilidades que ahora aplico para construir software eficiente y centrado en el usuario. Cuento con conocimientos en tecnologías de desarrollo web como Python, PHP, JavaScript, HTML, CSS y MySQL, y utilizo herramientas como Figma y Notion para la planificación y prototipado. Busco una oportunidad para aportar mi capacidad de análisis y mi creciente conjunto de habilidades técnicas a un equipo de desarrollo.
